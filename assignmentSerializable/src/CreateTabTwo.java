...
public class CreateTabTwo {
	...
	private void tabTwoTop(JPanel procTop, MyController controller) {
	...
	private void tabTwoMiddle(JPanel procMiddle, MyController controller, CreateGUI myGUI) {
	...
	private void tabTwoBottom(JPanel procBottom, MyController controller, CreateGUI myGUI) {
