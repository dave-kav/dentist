...
public class CreateTabFour {
	...
	private void tabFourTop (JPanel procTop, final MyController controller) {
	...
	private void tabFourMiddle(JPanel procMiddle2, final MyController controller) {
		...
		reportMiddle.setBorder		(BorderFactory.createTitledBorder("Late Payment Report"));
