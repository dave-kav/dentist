 ...
 */import java.awt.*;
 ...
 public class CreatePatientPopUp {
	 ...
	 private void createPatInfoPanel(final Patient myPatient, JPanel panel, final MyController controller, CreateGUI myGUI) {
		 //create components
	 ...
	 private void createEditPatPanel(final Patient myPatient, JPanel panel, final MyController controller, final CreateGUI myGUI) {
		 //create top components for 1st tab
		 JLabel fNameL 		= 	new JLabel("First Name:");
		 JLabel lNameL 		= 	new JLabel("Last Name:");
		 JLabel addressL	= 	new JLabel("Address:");
		 JLabel phoneL 		= 	new JLabel("Phone Number:");
		 final JTextField fName 	= 	new JTextField(22);
		 final JTextField lName 	= 	new JTextField(22);
		 final JTextField address	= 	new JTextField(22);
	 ...
	 private void createProcPanel(final Patient myPatient, JPanel panel, final MyController controller, final CreateGUI myGUI) {
	 ...
	 private void createPayPanel(final Patient myPatient, JPanel panel, final MyController controller, final CreateGUI myGUI) {
		 //create top components for 1st tab
		 JLabel dateL 		= 	new JLabel("Date:");
		 JLabel dateFormatL	=	new JLabel("(dd/mm/yyyy)");
		 JLabel amountL		= 	new JLabel("Amount:");
		 final JTextField date 	= 	new JTextField(22);
		 final JTextField amount	= 	new JTextField(22);
		 JButton add		= 	new JButton("Add");
		 JButton reset		= 	new JButton("Reset");
