...
public class CreateTabOne {
	...
	private void createTabOneTop(JPanel patTopPanel, final MyController controller, final CreateGUI myGUI) {
		//create top components for 1st tab
		JLabel fNameL 		= 	new JLabel("First Name:");
		JLabel lNameL 		= 	new JLabel("Last Name:");
		JLabel addressL		= 	new JLabel("Address:");
		JLabel phoneL 		= 	new JLabel("Phone Number:");
		final JTextField fName 	= 	new JTextField(24);
		final JTextField lName 	= 	new JTextField(24);
		final JTextField address	= 	new JTextField(24);
		final JTextField phone 	= 	new JTextField(24);
	...
	private void createTabOneMiddle(JPanel patMiddlePanel, final MyController controller, final CreateGUI myGUI) {
		...
		final JTextField nameSearch 		= 	new JTextField(24);
		final JTextField patientNoSearch	= 	new JTextField(24);
	...
	private void createTabOneBottom(JPanel patBottom, final MyController controller, CreateGUI myGUI) {
