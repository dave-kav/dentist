...
public class CreateTabThree {
	...
	private void tabThreeTop(JPanel payMiddle, final MyController controller) {
		...
		final JComboBox<String> patientNames=new JComboBox<String>(choices);
		...
		final JTextField date			= 	new JTextField(23);
		final JTextField amount		= 	new JTextField(23);
